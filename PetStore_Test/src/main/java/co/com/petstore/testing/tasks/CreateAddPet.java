...
public class CreateAddPet implements Task {

    private final PetInfo petInfo;

    public CreateAddPet(PetInfo petInfo) {
        this.petInfo = petInfo;
    }

    public static CreateAddPet requestJson(PetInfo petInfo) {
        return Tasks.instrumented(CreateAddPet.class, petInfo);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        AddPetInfoRequestJson petInformationJson = new AddPetInformationRequestJsonBuilder()
                .withPetId(GenerateRandom.data(2))
